...
void display(void)
{
	...
	cloth1.addForce(glm::vec3(0, -0.2, 0)*TIME_STEPSIZE2); // add gravity each frame, pointing down
	cloth1.windForce(glm::vec3(0.5, 0, 0.2)*TIME_STEPSIZE2); // generate some wind each frame
